...
@section('content')
    ...
    <section class="bg-light">
        <div class="container py-4">
            <h1 class="h6 mb-3">TỔNG ĐẠI LÝ PHÂN PHỐI CHÍNH HÃNG BIA HƠI HÀ NỘI - THÔNG THỦY</h1>
            ...
            <p><svg width="14" height="16" viewBox="0 0 14 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path
                        ...
                        fill="#619E12"></path>
                </svg>&nbsp; SĐT: <a href="tel:0983068870">0983068870</a></p>
            <p><svg width="16" height="13" viewBox="0 0 16 13" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path
                        ...
                        fill="#619E12"></path>
                </svg>&nbsp; Email: <a href="mailto:biahoithongthuy@gmail.com">biahoithongthuy@gmail.com</a></p>
            <p><svg width="16" height="13" viewBox="0 0 16 13" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path
                        ...
                        fill="#619E12"></path>
                </svg>&nbsp; Website: <a href="/">biahoithongthuy.com</a></p>

            <form method="POST" id="form" onsubmit="return common.submitForm(event)">
                <label for="ho-va-ten" class="form-label">Họ và tên<span class="text-danger">*</span></label>
                <input type="text" class="form-control mb-3" id="ho-va-ten" name="ho-va-ten" required>
                <label for="so-dien-thoai" class="form-label">Số điện thoại<span class="text-danger">*</span></label>
                <input type="text" class="form-control mb-3" id="so-dien-thoai" name="so-dien-thoai" required>
                <label for="email" class="form-label">Email</label>
                <input type="email" class="form-control mb-3" id="email" name="email">
                <label for="dia-chi" class="form-label">Địa chỉ</label>
                <input type="text" class="form-control mb-3" id="dia-chi" name="dia-chi">
                <label for="noi-dung" class="form-label">Nội dung</label>
                <textarea name="noi-dung" id="noi-dung" class="form-control mb-3" rows="3"></textarea>

                <!-- Modal footer -->
                <button type="submit" class="btn btn-success">Gửi yêu
                    cầu</button>
            </form>
