...
@section('content')
    ...
    <section class="py-5 px-3 hop-tac">
        <div class="text-center bg-light py-5 rounded">
            ...
            <div class="font-italic fs-3">
                <p><span>Hợp tác với chúng tôi bạn sẽ được <strong>đầu tư 100%</strong> trang thiết bị: từ <strong>tủ bảo
            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <div class="w-100 pt-3">
                        ...
                        <p class="text-start text-light text-center">Với nhiều năm kinh nghiệm trong lĩnh vực phân phối
                            bia, chúng tôi
                            mang đến cho khách hàng nhiều sự lựa chọn về sản phẩm cùng cam kết về chất lượng và giá cả cạnh
                            tranh nhất.</p>
                    </div>
                </div>
                ...
                <div class="col-12">
                    ...
                    <div class="w-100 pt-3">
                        ...
                        <p class="text-start text-light text-center">Giao hàng tận nhà, hàng ngày, miễn phí vận chuyển, số
                            lượng không
                ...
                <div class="col-12">
                    ...
                    <div class="w-100 pt-3">
                        ...
                        <p class="text-start text-light text-center">Tư vấn cách kinh doanh, kỹ thuật bảo quản và chắt rót
                            bia, quý
                            khách hàng có thể liên hệ qua tất cả các kênh: Website, Facebook, Zalo, hotline sẵn sàng phục vụ
                            bạn
                    ...
                    <div class="card-body p-3">
                        ...
                        <p><svg width="14" height="16" viewBox="0 0 14 16" fill="none"
                                ...
                                <path
                                    ...
                                    fill="#619E12"></path>
                            </svg> SĐT: <a href="tel:0983068870" class="ms-2 text-white">0983068870</a></p>
                        <p><svg width="16" height="13" viewBox="0 0 16 13" fill="none"
                                ...
                                class="ms-2 text-white">biahoithongthuy@gmail.com</a></p>
                        <p><svg width="16" height="13" viewBox="0 0 16 13" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                                <path
                                    ...
                                    fill="#619E12"></path>
                            </svg> Website: <a href="/" class="ms-2 text-white">biahoithongthuy.com</a></p>
                    </div>
                </div>
                <div class="col-12">
                    <div class="card-body p-3">
    ...
    <section class="py-3 bg-dark text-white">
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <div class="text-center text-white">Copyright <b>@</b> <a href="/" class="text-white">Đại lý
