...
<body>
                    ...
                    <div class="card-body p-3">
                        ...
                        <p><svg width="14" height="18" viewBox="0 0 14 18" fill="none"
                                ...
                                <path
                                    ...
                                    fill="#619E12"></path>
                            </svg>&nbsp; Địa chỉ: Phường Tân Sơn, Thị xã Kim Bảng, Tỉnh Hà Nam.</p>
            ...
            <div class="modal-content">
                ...
                <form method="POST" id="form" onsubmit="return common.submitForm(event)">
                    <div class="modal-body">
                        ...
                        <input type="text" class="form-control mb-3" id="so-dien-thoai"
                            placeholder="Số điện thoại" name="so-dien-thoai" required>
    ...
    <script type="text/javascript">
        var _Hasync = _Hasync || [];
        _Hasync.push(['Histats.start', '1,4934717,4,24,200,50,00011111']);
    ...
    <noscript><a href="/" target="_blank"><img src="//sstatic1.histats.com/0.gif?4934717&101" alt=""
                border="0"></a></noscript>
    <!-- Histats.com  END  -->
